-- =====================================================
-- ORKUT.BR - SCRIPT CORRIGIDO PARA SUPABASE
...
DROP POLICY IF EXISTS "Communities visíveis por todos" ON public.communities;
